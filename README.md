...
<div align="center">
  <img src="docs/hero-banner.png" alt="PrepPilot — AI-Powered Interview Readiness Analyzer" width="100%" />
</div>
...
|---|---|
| ![Dashboard](docs/screenshots/dashboard.png) | ![Interview Setup](docs/screenshots/interview-setup.png) |
| At-a-glance stats, recent sessions, quick actions | Interviewer style, type, and difficulty selection |

| Readiness Report | Resume Analyzer |
|---|---|
| ![Readiness Report](docs/screenshots/readiness-report.png) | ![Resume Analyzer](docs/screenshots/resume-analyzer.png) |
| Hybrid score breakdown, competency radar, per-question feedback | Match score, strengths, skill gaps, missing keywords |

| AI Coach | Analytics |
|---|---|
| ![AI Coach](docs/screenshots/ai-coach.png) | ![Analytics](docs/screenshots/analytics.png) |
| Context-aware chat referencing real performance data | Score trends, skill radar, performance by interview type |
